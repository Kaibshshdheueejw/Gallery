...
const SHOTS: Shot[] = [
  {
    ...
    title: 'UPI payment — Agartala Coffee House',
    ocr: 'Payment Successful 240.00 paid to Agartala Coffee House UPI ID ach@okaxis 07 Sep 2026 9:42 AM UPI Ref 4281773399',
    svg: shell(`
      ...
      <text x="180" y="378" text-anchor="middle" font-family="sans-serif" font-size="40" fill="#7ee2a8">₹240.00</text>
      <text x="180" y="412" text-anchor="middle" font-family="sans-serif" font-size="16" fill="#9db8a4">paid to Agartala Coffee House</text>
      <rect x="40" y="452" width="280" height="1" fill="#28402f"/>
      <text x="180" y="492" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#9db8a4">UPI ID ach@okaxis</text>
      <text x="180" y="520" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#9db8a4">07 Sep 2026, 9:42 AM</text>
      <text x="180" y="548" text-anchor="middle" font-family="sans-serif" font-size="13" fill="#6f8a77">UPI Ref 4281773399</text>
  ...
  },
  {
    ...
    title: 'Chat — Sneha',
    ocr: 'Sneha send me the Goa photos pls you on it sending tonight 22:14',
    svg: shell(`
      ...
      <text x="38" y="69" text-anchor="middle" font-family="sans-serif" font-size="15" fill="#fff">S</text>
      <text x="66" y="60" font-family="sans-serif" font-size="16" fill="#e8f0f7">Sneha</text>
      ...
      <text x="136" y="172" font-family="sans-serif" font-size="14" fill="#e8f0f7">send me the Goa photos</text>
  ...
  },
  {
    ...
    title: 'IRCTC e-ticket AGTL → KOAA',
    ocr: 'IRCTC e-Ticket AGTL KOAA Train 12504 Humsafar Express 12 Sep 2026 PNR 4521 77 Coach B2 Seat 34 Confirmed',
    svg: shell(`
      <rect x="0" y="34" width="360" height="746" fill="#f2f5f9"/>
      <rect x="0" y="34" width="360" height="66" fill="#c62828"/>
      <text x="24" y="74" font-family="sans-serif" font-size="20" fill="#fff">IRCTC e-Ticket</text>
      <rect x="24" y="130" width="312" height="220" rx="14" fill="#ffffff"/>
      <text x="44" y="170" font-family="sans-serif" font-size="24" fill="#1c2733">AGTL → KOAA</text>
      <text x="44" y="200" font-family="sans-serif" font-size="14" fill="#5a6b7c">Train 12504 · Humsafar Express</text>
      <text x="44" y="238" font-family="sans-serif" font-size="16" fill="#1c2733">12 Sep 2026 · 06:15</text>
      <text x="44" y="268" font-family="sans-serif" font-size="14" fill="#5a6b7c">PNR 4521 77 234 88</text>
      <rect x="44" y="288" width="272" height="1" fill="#dbe3ea"/>
      <text x="44" y="320" font-family="sans-serif" font-size="15" fill="#1c2733">Coach B2 · Seat 34</text>
      ...
      <text x="44" y="444" font-family="sans-serif" font-size="20" fill="#1c2733">₹1,180.00</text>`, '#f2f5f9'),
  },
  {
    id: 'scr-4',
    at: '2026-09-06T21:37:00',
    title: 'Now playing — Monsoon Mix',
    ocr: 'Now playing Monsoon Mix Anupam Roy 3:42 playlist Rainy evenings',
    svg: shell(`
      ...
      <text x="180" y="420" text-anchor="middle" font-family="sans-serif" font-size="24" fill="#f1ecff">Monsoon Mix</text>
      <text x="180" y="450" text-anchor="middle" font-family="sans-serif" font-size="16" fill="#a79bc9">Anupam Roy</text>
  ...
  },
  {
    ...
    title: 'Weather — Agartala',
    ocr: 'Agartala 31° Heavy rain expected tonight Humidity 88% Mon 32° Tue 30° Wed 29°',
    svg: shell(`
      <rect x="0" y="34" width="360" height="746" fill="#0d2137"/>
      <text x="180" y="130" text-anchor="middle" font-family="sans-serif" font-size="22" fill="#dcecf9">Agartala</text>
      <text x="180" y="230" text-anchor="middle" font-family="sans-serif" font-size="88" fill="#ffffff">31°</text>
      <text x="180" y="268" text-anchor="middle" font-family="sans-serif" font-size="16" fill="#9dc3de">Heavy rain expected tonight</text>
      <text x="180" y="296" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#7ba6c4">Humidity 88%</text>
      ...
      <text x="48" y="396" font-family="sans-serif" font-size="15" fill="#bcd8ea">Mon</text><text x="288" y="396" text-anchor="end" font-family="sans-serif" font-size="15" fill="#fff">32°</text>
      <text x="48" y="430" font-family="sans-serif" font-size="15" fill="#bcd8ea">Tue</text><text x="288" y="430" text-anchor="end" font-family="sans-serif" font-size="15" fill="#fff">30°</text>
      <text x="48" y="464" font-family="sans-serif" font-size="15" fill="#bcd8ea">Wed</text><text x="288" y="464" text-anchor="end" font-family="sans-serif" font-size="15" fill="#fff">29°</text>`, '#0d2137'),
  },
  {
    id: 'scr-6',
    at: '2026-08-30T16:48:00',
    title: 'Route — Ujjayanta Palace',
    ocr: 'Ujjayanta Palace 12 min via Airport Rd 4.2 km traffic light Start',
    svg: shell(`
      ...
      <text x="36" y="462" font-family="sans-serif" font-size="21" fill="#1c2733">Ujjayanta Palace</text>
      <text x="36" y="496" font-family="sans-serif" font-size="26" fill="#1f6f43">12 min</text>
      <text x="130" y="496" font-family="sans-serif" font-size="15" fill="#5a6b7c">via Airport Rd</text>
